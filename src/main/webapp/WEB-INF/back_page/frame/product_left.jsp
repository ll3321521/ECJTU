...
<%@ include file="/WEB-INF/back_page/date.jsp" %>
     <ul class="w-lful">
		<li><a href="<%=request.getContextPath() %>/product/list.do" target="rightFrame">商品管理</a></li>
		<li><a href="<%=request.getContextPath() %>/brand/list.do" target="rightFrame">品牌管理</a></li>
		<li><a href="<%=request.getContextPath() %>/type/list.do" target="rightFrame">类型管理</a></li>
     </ul>
</div>
</body>
</html>