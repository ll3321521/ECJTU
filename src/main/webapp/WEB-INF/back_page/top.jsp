...
<div id="top">
     <div class="top">
          ...
          <tr>
            <td width="215"><div class="logo"><img src="<%=request.getContextPath() %>/res/itcast/img/admin/logo.jpg" width="215" height="69" /></div></td>
            <td valign="top">
                <div class="topbg">
                     <div class="login-welcome">
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <img src="<%=request.getContextPath() %>/res/itcast/img/admin/welconlogin-icon.png"/><span id="welcome">您好:admin!</span>
                                    <img src="<%=request.getContextPath() %>/res/itcast/img/admin/loginout-icon.png"/><a href="logout.do?returnUrl=index.do" target="_top" id="logout" onclick="return confirm('您确定退出吗?');">退出</a> 
                                    <img src="<%=request.getContextPath() %>/res/itcast/img/admin/message-unread.png"/>&nbsp;<a href="message/v_list.do" target="rightFrame">你有<span id="countDiv">0</span>条信息未读</a>
                                    </td>
                                  </tr>
                                </table>
                       </div>  
