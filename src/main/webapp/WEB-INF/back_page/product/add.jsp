	...
	$("#tabs a").each(function(){
		...
		$(this).click(function(){
			...
			if(ref == '#tab_2'){
				...
				fck.Height = 400 ;
				fck.Config["ImageUploadURL"]="${pageContext.request.contextPath}/upload/uploadFck.do";
				fck.ReplaceTextarea();
			}
		});
	});
...
<div class="box-positon">
	...
	<form class="ropt">
		<input type="submit" onclick="this.form.action='<%=request.getContextPath() %>/product/list.do';" value="返回列表" class="return-button"/>
	</form>
	<div class="clear"></div>
</div>
...
<div class="body-box" style="float:right">
	<form id="jvForm" action="<%=request.getContextPath() %>/product/add.do" method="post" enctype="multipart/form-data">
