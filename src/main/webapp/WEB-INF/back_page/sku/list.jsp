...
function saveSku(skuId) {
	...
	//保存
	var url="${pageContext.request.contextPath}/sku/update.do";
	var data={"marketPrice":m,
			"skuPrice":p,
			"stockInventory":s,
			"skuUpperLimit":l,
			"deliveFee":f,
	...
	<tbody class="pn-ltbody">
		<c:forEach items="${skus}" var="sku">
			<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
				...
				<td align="center"><input type="text" id="s${sku.id}" value="${sku.stockInventory}" disabled="disabled" size="10"/></td>
