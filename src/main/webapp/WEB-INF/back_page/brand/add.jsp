...
<div class="box-positon">
	...
	<form class="ropt">
		<input type="submit" onclick="this.form.action='<%=request.getContextPath() %>/brand/list.do';" value="返回列表" class="return-button"/>
	</form>
	<div class="clear"></div>
</div>
<div class="body-box" style="float:right">
	<form id="jvForm" action="<%=request.getContextPath() %>/brand/add.do" method="post" enctype="multipart/form-data">
