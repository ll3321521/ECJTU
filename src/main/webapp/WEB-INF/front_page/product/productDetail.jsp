...
<script type="text/javascript" src="<%=request.getContextPath() %>/res/js/com.js"></script>
<style type="text/css">
.changToRed {
...
function buy(productId){
	window.location.href='${pageContext.request.contextPath}/shop/cart.shtml?skuId=' + skuId + "&number=" + $("#num").val() + "&buyLimit=" + buyLimit + "&productId=" + productId;
}
</script>
</head>
<body>
			...
			<li><label>选择颜色：</label>
				<div id="colors" class="pre spec">
					...
					<a onclick="colorToRed(this,${color.id})" href="javascript:void(0)" title="${color.name}" class="changToWhite">
						<img width="25" height="25" data-img="1" src="${product.img.allUrl}" alt="${color.name} "><i>${color.name}</i></a>
					</c:forEach>
				</div>
			</li>
			<li id="sizes"><label>尺　　码：</label>
						<a onclick="sizeToRed(this,'S')" href="javascript:void(0)" class="not-allow"  id="S">S</a>
						<a onclick="sizeToRed(this,'M')" href="javascript:void(0)" class="not-allow"  id="M">M</a>
						<a onclick="sizeToRed(this,'L')" href="javascript:void(0)" class="not-allow"  id="L">L</a>
						<a onclick="sizeToRed(this,'XL')" href="javascript:void(0)" class="not-allow"  id="XL">XL</a>
						<a onclick="sizeToRed(this,'XXL')" href="javascript:void(0)" class="not-allow"  id="XXL">XXL</a>
			</li>
