...
<form action="<%=request.getContextPath()%>/buyer/confirmOrder.shtml" method="post">
	...
	<div class="box bg_white pb">
	 ...
	 <div class="confirm mt">
		...
		<div class="ofc">
			<div class="r">
				<dl class="total">
					<dt>订单金额：<cite>(共<var id="totalNum">${cart.number}</var>个商品)</cite></dt>
					<dd><em class="l">商品金额：</em>￥<var>${cart.price}</var></dd>
					<dd><em class="l">返现：</em>￥<var>0.00</var></dd>
					<dd><em class="l">运费：</em>￥<var>${cart.fee}</var></dd>
